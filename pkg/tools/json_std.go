...
var (
	// Marshal is standard library implementation.
	Marshal = json.Marshal
	// Unmarshal is standard library implementation.
	Unmarshal = json.Unmarshal
	// MarshalIndent is standard library implementation.
	MarshalIndent = json.MarshalIndent
	// NewDecoder is standard library implementation.
