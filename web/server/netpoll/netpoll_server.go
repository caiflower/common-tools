...
//	controller2 "github.com/caiflower/common-tools/web/common/controller"
...
//
//	// Netpoll 特有配置
//	NetpollSpecialConfig `yaml:"netpoll"`
//}
//type NetpollSpecialConfig struct {
//	BufferSize int `yaml:"bufferSize" default:"1024000"`
//}
//
...
//	ctx           webctx.Context
//	cancel        webctx.CancelFunc
//
//	bufferPool   *sync.Pool
//	responsePool *sync.Pool
//}
//
//func NewNetpollHttpServer(config web.NetpollConfig) *NetpollHttpServer {
//	_ = tools.DoTagFunc(&config, nil, []func(reflect.StructField, reflect.Value, interface{}) error{tools.SetDefaultValueIfNil})
//
//	ctx, cancel := webctx.WithCancel(webctx.Background())
//
//	server := &NetpollHttpServer{
//		config: &config,
...
//
//	// 初始化公共处理器
//	web.initHandler(&config.NormalConfig, server.logger)
//	server.handler = web.commonHandler
//
//	return server
//}
//
...
//	c, err := web.newController(v, s.config.ControllerRootPkgName, s.config.RootPath)
//	if err != nil {
...
//}
//
//func (s *NetpollHttpServer) Register(controller *controller2.RestfulController) {
...
//}
//
//func (s *NetpollHttpServer) SetBeforeDispatchCallBack(callbackFunc router.BeforeDispatchCallbackFunc) {
...
//	onRequest := func(ctx webctx.Context, connection netpoll.Connection) error {
//		// 处理连接
